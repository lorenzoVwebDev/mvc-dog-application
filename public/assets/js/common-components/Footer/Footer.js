...
let Footer = `<footer class="footer-container">
      <div class="footer-header">
        ...
        <div class="social-icons-container">
          <a class="social-icons" href="https://www.instagram.com/lorenzoviganego/?igsh=eHhoMWpqZXozN3B2#">
            <svg
          ...
          <a class="social-icons" href="https://www.linkedin.com/in/lorenzo-viganego-1325441a3/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class=""
              fill="white"
          ...
          <a class="social-icons" href="https://github.com/lorenzoVwebDev">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class=""
              fill="white"
      ...
      <div class="main-footer-section">
        <div class="main-footer-section-grid">
          <div class="main-footer-section-left">
            <h6>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <div class="main-footer-section-right">
            <h6>
              Contacts
            </h6>
            <p>
